...
cargar.addEventListener("click", () => {
   ...
   resultado = parseInt(input5) + parseInt(input4) + parseInt(input3) + parseInt(input2) + parseInt(input1)

   porcentaje.innerHTML = resultado

   let total1= parseInt(input1) * 100 / resultado
   caja1.style.width= `${total1}%`
   
   let total2 = parseInt(input2) * 100 / resultado
   caja2.style.width= `${total2}%`
    
   let total3 = parseInt(input3) * 100 / resultado
   caja3.style.width= `${total3}%`

   let total4 = parseInt(input4) * 100 / resultado
   caja4.style.width= `${total4}%`

   let total5 = parseInt(input5) * 100 / resultado
